function create_menu(basepath)
{
	...
	document.write(
		...
		'<h3>Basic Info</h3>' +
		'<ul>' +
		'	<li><a href="http://cosmointeractive.co" target="_blank">Cosmo Mathieu</a></li>' +
		'	<li><a href="'+base+'changelog.html">Changelog</a></li>' +
		'	<li><a href="'+base+'index.html#license">License</a></li>' +
		'	<li><a href="https://github.com/cosmointeractive/pagestudio.framework" target="_blank">GitHub</a></li>' +
		...
		'<h3>Libraries</h3>' +
		'<ul>' +
            '<li><a href="'+base+'docs-database.html#introduction">Database Query Builder</a></li>' +
            '<li><a href="'+base+'docs-input-validator.html#introduction">Inpurt Validator</a></li>' +
            '<li><a href="'+base+'docs-router.html#introduction">URI Router</a></li>' +
		'</ul>' +
